...
name: Omarchy
description: Linux desktop config: Hyprland, waybar, walker, mako, terminal emulators, themes. REQUIRED before editing anything under ~/.config/ for those, or running an omarchy-* command.
---
