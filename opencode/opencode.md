...
- **Parallelism required**: split multi-topic research/work into parallel `task` calls (≥3 when ≥3 topics). Never run sequential waits or aggregated researchers.
